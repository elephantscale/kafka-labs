...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static x.lab08_avro.Customer.Builder newBuilder() {
    return new x.lab08_avro.Customer.Builder();
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static x.lab08_avro.Customer.Builder newBuilder(x.lab08_avro.Customer.Builder other) {
    if (other == null) {
      return new x.lab08_avro.Customer.Builder();
    } else {
      return new x.lab08_avro.Customer.Builder(other);
    }
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static x.lab08_avro.Customer.Builder newBuilder(x.lab08_avro.Customer other) {
    if (other == null) {
      return new x.lab08_avro.Customer.Builder();
    } else {
      return new x.lab08_avro.Customer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(x.lab08_avro.Customer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(x.lab08_avro.Customer other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public x.lab08_avro.Customer.Builder clearEmail() {
      email = null;
