...
## Step-6: Send a few thousand records

First install Kafka python package

```bash
$   pip install confluent_kafka
```

And run this python producer code.  This will send a few thousand records, while updating keys with values


```bash
$   python  compaction-producer.py
```

Then run the console-consumer to read all the records
