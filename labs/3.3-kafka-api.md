...
```bash
$   java -cp target/kafka-labs-2.0-jar-with-dependencies.jar   x.lab3_api_intro.ClickstreamConsumer
...
```bash
$    java -cp target/kafka-labs-2.0-jar-with-dependencies.jar    x.lab3_api_intro.ClickstreamProducer
